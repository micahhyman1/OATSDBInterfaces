 ...
 * throws this exception when a calling thread that is already associated with
 * a transaction attempts to start a new transaction. (A nested transaction
 * occurs when a thread is already associated with one transaction and attempts
